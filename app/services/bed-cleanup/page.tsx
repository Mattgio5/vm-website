  ...
  return (
    <main>
      ...
      <ServiceDetail
        ...
        benefitsIntro="A bed cleanup looks simple from the outside, but the difference between a fast pass with a leaf blower and an actual reset is huge. Here's what hiring the right crew gets you:"
        benefits={[
          {
